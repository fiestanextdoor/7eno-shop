...
// Product classification (gender, category, collection) lives in
// lib/product-classify.ts so the shop filters and the Merchant Center feed
// describe every product identically.
