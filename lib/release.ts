 ...
 * automatically. Launch: 12 June 2026, 19:00 Europe/Amsterdam (CEST = UTC+2),
 * i.e. 17:00 UTC. Month is 0-based in Date.UTC, so 5 = June.
 */
export const RELEASE_AT_UTC = Date.UTC(2026, 5, 12, 17, 0, 0)

/** Human-readable launch moment for the announcement page. */
export const RELEASE_DATE_LABEL = '12 June 2026'
